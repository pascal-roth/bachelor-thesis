...
echo "Network 008:"
python contour.py --pode $pode -nbr_net 008 -phi $equivalence_ratio -p $pressure

echo "Network 009:"
python contour.py --pode $pode -nbr_net 009 -phi $equivalence_ratio -p $pressure

echo "Network 010:"
python contour.py --pode $pode -nbr_net 010 -phi $equivalence_ratio -p $pressure

echo "Network 011:"
python contour.py --pode $pode -nbr_net 011 -phi $equivalence_ratio -p $pressure

echo "Network 012:"
python contour.py --pode $pode -nbr_net 012 -phi $equivalence_ratio -p $pressure

echo "Network 013:"
python contour.py --pode $pode -nbr_net 013 -phi $equivalence_ratio -p $pressure

echo "Network 014:"
python contour.py --pode $pode -nbr_net 014 -phi $equivalence_ratio -p $pressure

echo "Network 015:"
python contour.py --pode $pode -nbr_net 015 -phi $equivalence_ratio -p $pressure