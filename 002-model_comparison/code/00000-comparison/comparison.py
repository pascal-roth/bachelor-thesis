...
def parseArgs():
    ...
    parser.add_argument("--comparison", type=str, choices=['ID', 'thermo', 'educts', 'products'], default='products',
                        help="chose what should be compared")

    parser.add_argument("--pode", type=int, default=3,
                        help="chose degree of polymerization")

    parser.add_argument("-phi", "--equivalence_ratio", type=float, choices=[0.5, 0.67, 1.0], default=0.5,
