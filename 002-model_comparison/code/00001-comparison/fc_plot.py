...
def plot_outputs(y_samples, y_samples_nn, samples_grm, x_samples, features, labels, x_scaler):
    """
    ...
    for i, label_run in enumerate(labels):
        ...
        samples_feature = x_samples[features].to_numpy()
        samples_feature = x_scaler.inverse_transform(samples_feature)
