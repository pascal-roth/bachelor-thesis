...
python iterator.py -mech cai --pode 3 -nbr_run 003 --category test --phi_0 1.50 --phi_end 1.50 --phi_step 1.00 --p_0 40 --p_end 40 --p_step 40 -t_0 1065 -t_end 1065 -t_step 30
