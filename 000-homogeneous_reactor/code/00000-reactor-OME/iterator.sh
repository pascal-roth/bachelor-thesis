...
while true; do
	...
	case $yn in
		[Yy]* ) read -p "phi_0             [default: 0.50]     : " phi_0
			    ...
			    python iterator.py -mech $mechanism --pode $pode_n -nbr_run $name --category $category --phi_0 $phi_0 --phi_end $phi_end --phi_step $phi_step --p_0 $p_0 --p_end $p_end --p_step $p_step -t_0 $t_start -t_end $t_end -t_step $t_step ; break;;
		[Nn]* ) python iterator.py -mech $mechanism --pode $pode_n -nbr_run $name --category $category; exit;;
