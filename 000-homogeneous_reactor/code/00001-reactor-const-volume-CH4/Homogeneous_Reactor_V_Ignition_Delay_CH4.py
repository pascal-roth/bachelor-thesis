...
for i in range(0, len(reactorTemperature), 1):
    ...
    gas.set_equivalence_ratio(equivalence_ratio, 'CH4', 'O2:0.21, N2:0.79')
    ...
    K_w1 = 0                # Wall expansion rate parameter [m/s/Pa]
...
if plot_ign is True:
    ...
    ax.semilogy(1000 / ignitionDelays['T'], ignitionDelays['ignDelay'], 'o-', label='CH4')
    ...
    textstr = '$\\theta$=%.2f\np=%.0f\n' % (equivalence_ratio, reactorPressure)
